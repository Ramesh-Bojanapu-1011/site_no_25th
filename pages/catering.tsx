...
const Catering = () => {
  ...
  const foodSections = [
    // Section 1: How Our Catering Works
    {
      ...
      desc: t(
        "Catering_How_Desc",
        "From your first inquiry to the last bite, our process ensures a seamless and memorable catering experience.",
      ),
            ...
            <div className="relative z-10 flex flex-col gap-0">
              {[
                ...
                },
                {
                  ...
                  desc: t(
                    "Catering_Step2_Desc",
                    "Choose dishes and services to fit your occasion",
                  ),
                },
                {
                  ...
                  desc: t(
                    "Catering_Step3_Desc",
                    "We coordinate logistics and details",
                  ),
                },
                {
                  ...
                  desc: t(
                    "Catering_Step4_Desc",
                    "Relax while we serve and manage everything",
                  ),
                },
              ].map((step, idx) => {
    ...
    // Section 2: Catering Styles & Setups
    {
      ...
      desc: t(
        "Catering_Types_Desc",
        "Select the perfect catering style and setup to match your event’s vibe and needs.",
      ),
          ...
          {[
            {
              ...
              img: "/buffet.jpg",
              desc: t(
                "Catering_Type_Buffet_Desc",
                "A wide variety of dishes for guests to choose from",
              ),
            },
            {
              ...
              img: "/plated.jpg",
              desc: t(
                "Catering_Type_Plated_Desc",
                "Elegant, individually served meals at each table",
              ),
            },
            {
              ...
              desc: t(
                "Catering_Type_Live_Desc",
                "Interactive stations with chefs preparing food live",
              ),
            },
          ].map((type) => (
            <div
    ...
    // Section 3: Why Reserve a Table?
    {
      ...
      desc: t(
        "Catering_Why_Desc",
        "Discover the benefits of choosing our catering services for your next event.",
      ),
      ...
      content: (
        <ul className="flex flex-col gap-4 text-zinc-700 dark:text-zinc-200 text-left max-w-xl mx-auto">
          ...
          <li className="flex items-center gap-3">
            ...
            {t(
              "Catering_Why_Memorable",
              "Make your celebration memorable—relax and enjoy, we’ll handle the rest!",
            )}
          </li>
        </ul>
      ),
    ...
    // Section 4: Customer Experiences
    {
      ...
      desc: t(
        "Catering_Experiences_Desc",
        "See what our clients are saying about our catering for their special events.",
      ),
    ...
    // Section 5: Book Your Table CTA
    {
      ...
      desc: t(
        "Catering_CTA_Desc",
        "Make your next celebration unforgettable with our expert catering services—perfect for parties, weddings, and corporate events.",
      ),
      icon: "/calendar.svg",
      content: (
        <div
        ...
        >
          ...
          <p className="text-lg text-zinc-700 dark:text-zinc-200 mb-6 max-w-xl">
            {t(
              "Catering_CTA_Reserve_Desc",
              "From menu design to on-site service, our catering team will work with you to create a delicious, stress-free event. Reach out for a custom quote and let’s make your occasion truly special.",
            )}
          </p>
          <Link
            href="/contact-us"
  ...
  return (
    <>
      <Head>
        <title>
          {t("Catering_Meta_Title", "Catering Services | Reserve Your Spot")}
        </title>
        <meta
          name="description"
          content={t(
        ...
        <section className="relative flex flex-col-reverse md:flex-row items-center justify-between px-4 py-16 md:py-24 mx-auto gap-8 min-h-[100vh]">
          ...
          <div className="flex-1 text-center md:text-left z-10">
            ...
            <p className="text-lg md:text-2xl text-zinc-700 dark:text-zinc-200 mb-6 max-w-xl">
              {t(
                "Catering_Hero_Desc",
                "From intimate gatherings to grand celebrations, our catering team delivers delicious food, flawless service, and unforgettable experiences. Let us handle the details—so you can enjoy your event stress-free.",
              )}
            </p>
            <Link
              href="#book-table"

...
const PartyOrders = () => {
  ...
  const partySections = [
    {
      title: t("PartyOrders_How_Title"),
      desc: t("PartyOrders_How_Desc"),
      content: (
              ...
              {[
                {
                  ...
                  label: t("PartyOrders_Step1_Label"),
                  desc: t("PartyOrders_Step1_Desc"),
                },
                {
                  icon: "https://www.svgrepo.com/show/277641/menu.svg",
                  label: t("PartyOrders_Step2_Label"),
                  desc: t("PartyOrders_Step2_Desc"),
                },
                {
                  icon: "https://www.svgrepo.com/show/64210/planning.svg",
                  label: t("PartyOrders_Step3_Label"),
                  desc: t("PartyOrders_Step3_Desc"),
                },
                {
                  icon: "https://www.svgrepo.com/show/397713/party-popper.svg",
                  label: t("PartyOrders_Step4_Label"),
                  desc: t("PartyOrders_Step4_Desc"),
                },
              ].map((step, idx) => {
    ...
    {
      title: t("PartyOrders_Menu_Title"),
      desc: t("PartyOrders_Menu_Desc"),
      content: (
        <div className="flex flex-wrap gap-8 justify-center items-center py-4">
          {[
            {
              name: t("PartyOrders_Menu_VegPlatter"),
              img: "/veg-platter.jpg",
              desc: t("PartyOrders_Menu_VegPlatter_Desc"),
            },
            {
              name: t("PartyOrders_Menu_NonVegPlatter"),
              img: "/nonveg-platter.jpg",
              desc: t("PartyOrders_Menu_NonVegPlatter_Desc"),
            },
            {
              name: t("PartyOrders_Menu_DessertPlatter"),
              img: "/dessert-platter.jpg",
              desc: t("PartyOrders_Menu_DessertPlatter_Desc"),
            },
            {
              name: t("PartyOrders_Menu_CustomPackage"),
              img: "/custom-package.jpg",
              desc: t("PartyOrders_Menu_CustomPackage_Desc"),
            },
          ].map((cat) => (
            <div
              key={cat.name}
    ...
    {
      title: t("PartyOrders_Why_Title"),
      desc: t("PartyOrders_Why_Desc"),
      content: (
          ...
          <li className="flex items-center gap-3">
            <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-gradient-to-br from-orange-200 to-yellow-200 dark:from-yellow-900 dark:to-yellow-700">
              <Image
                ...
                alt={t("PartyOrders_Why_Clock_Alt") || "On-Time Delivery"}
                width={20}
                height={20}
              />
            </span>
            {t("PartyOrders_Why_Clock")}
          </li>
          <li className="flex items-center gap-3">
            <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-gradient-to-br from-orange-200 to-yellow-200 dark:from-yellow-900 dark:to-yellow-700">
              <Image
                src="https://www.svgrepo.com/show/387128/chef-hat-one.svg"
                alt={t("PartyOrders_Why_Chef_Alt") || "Expert Chefs"}
                width={20}
                height={20}
              />
            </span>
            {t("PartyOrders_Why_Chef")}
          </li>
          <li className="flex items-center gap-3">
            <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-gradient-to-br from-orange-200 to-yellow-200 dark:from-yellow-900 dark:to-yellow-700">
              <Image
                src="https://www.svgrepo.com/show/428775/support-online-center.svg"
                alt={t("PartyOrders_Why_Support_Alt") || "Support"}
                width={20}
                height={20}
              />
            </span>
            {t("PartyOrders_Why_Support")}
          </li>
          <li className="flex items-center gap-3">
            <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-gradient-to-br from-orange-200 to-yellow-200 dark:from-yellow-900 dark:to-yellow-700">
              <Image
                src="https://www.svgrepo.com/show/425209/discount-tag-ecommerce.svg"
                alt={t("PartyOrders_Why_Discount_Alt") || "Special Offers"}
                width={20}
                height={20}
              />
            </span>
            {t("PartyOrders_Why_Discount")}
          </li>
        </ul>
      ),
    },
    {
      title: t("PartyOrders_Stories_Title"),
      desc: t("PartyOrders_Stories_Desc"),
      content: (
        <div className="flex flex-wrap gap-6 justify-center">
          {[
            {
              name: t("PartyOrders_Stories_User1_Name"),
              feedback: t("PartyOrders_Stories_User1_Feedback"),
              img: "/user2.jpg",
            },
            {
              name: t("PartyOrders_Stories_User2_Name"),
              feedback: t("PartyOrders_Stories_User2_Feedback"),
              img: "/user1.jpg",
            },
            {
              name: t("PartyOrders_Stories_User3_Name"),
              feedback: t("PartyOrders_Stories_User3_Feedback"),
              img: "/user4.jpg",
            },
            {
              name: t("PartyOrders_Stories_User4_Name"),
              feedback: t("PartyOrders_Stories_User4_Feedback"),
              img: "/user3.jpg",
            },
          ].map((item) => (
            <div
    ...
    {
      title: t("PartyOrders_Book_Title"),
      desc: t("PartyOrders_Book_Desc"),
      content: (
        <div
  ...
  return (
    <>
      <Head>
        <title>{t("PartyOrders_Meta_Title")}</title>
        <meta name="description" content={t("PartyOrders_Meta_Desc")} />
      </Head>
      <div className="bg-white dark:bg-zinc-900 min-h-screen transition-colors duration-300">
        ...
        <section className="relative flex flex-col-reverse md:flex-row items-center justify-between px-4 py-16 md:py-24 mx-auto gap-8 min-h-[100vh]">
          ...
          <div className="flex-1 text-center md:text-left z-10">
            ...
            >
              {t("PartyOrders_Hero_Book")}
            </Link>
          </div>
          <div className="flex-1 flex w-[70%] h-auto justify-center z-10">
            <Image
              src="/party-orders-hero.jpg"
              alt={t("PartyOrders_Hero_Image_Alt")}
              width={420}
              height={420}

    ...
    <div className="bg-white dark:bg-zinc-900 transition-colors duration-300">
      ...
      >
        ...
        <div className="flex-1 flex flex-col justify-center items-start md:items-start z-20">
          ...
          <p className="text-lg md:text-2xl   dark:text-zinc-200 mb-8 max-w-2xl">
            ...
            journey, our values, and our commitment to serving you the best food
            experience possible.
          </p>
        </div>
      ...
      >
        <div className="flex-1 flex flex-col items-start" data-aos="fade-right">
          ...
          >
            ...
            safely, and sustainably. We envision a world where every meal is an
            opportunity to bring people together, celebrate culture, and create
            lasting memories. Our vision is to harness technology and innovation
            to make food delivery more personal, enjoyable, and eco-friendly. By
            fostering strong partnerships with local businesses and embracing
            sustainable practices, we aim to inspire positive change in the
            communities we serve and set new standards for excellence in the
        ...
        >
          <div className="relative group">
            <img
              ...
              style={{ filter: "drop-shadow(0 8px 32px rgba(255,180,0,0.15))" }}
            />
      ...
      >
        ...
        >
          ...
          >
            To make great food accessible to everyone, everywhere. We strive to
            support local restaurants, empower delivery partners, and delight
            customers with every order. Our mission is to create a seamless,
            joyful food experience for all, while uplifting the communities we
            serve and driving positive change in the industry. We are committed
            to innovation, quality, and sustainability at every step. We believe
            that food is more than just nourishment—it's a way to connect,
            celebrate, and care for one another. Every meal delivered is an
              ...
              {[
                ...
                >
                  <Image
                    src={member.img}
                    alt={member.name}
                    className="w-20 h-20 rounded-full border-2 border-orange-200 dark:border-yellow-400 object-cover shadow"
                    width={80}
                    height={80}
                  />
                  <div>
          ...
          >
            ...
            >
              ...
              <p className="text-zinc-700 dark:text-zinc-200 text-lg mb-2 text-justify">
                Our team is a vibrant blend of foodies, techies, creatives, and
                community champions. We come from diverse backgrounds, but share
                a single passion: making every meal memorable for you.
              </p>
              ...
              <div className="w-full flex flex-col md:flex-row gap-4 mt-2">
                <div className="flex-1 bg-gradient-to-r from-orange-100 via-yellow-50 to-white dark:from-yellow-900 dark:via-orange-900 dark:to-zinc-900 rounded-xl p-4 shadow border-l-4 border-orange-300 dark:border-yellow-500">
                  ...
                  <span className="text-zinc-700 dark:text-zinc-200 text-sm">
                    ...
                    supporting each other’s growth—because together, we achieve
                    more.
                  </span>
                </div>
                <div className="flex-1 bg-gradient-to-r from-yellow-100 via-orange-50 to-white dark:from-orange-900 dark:via-yellow-900 dark:to-zinc-900 rounded-xl p-4 shadow border-l-4 border-yellow-400 dark:border-orange-400">
                  ...
                  <span className="text-zinc-700 dark:text-zinc-200 text-sm">
                    ...
                    others, and help create a positive impact for our customers
                    and community.
                  </span>
                </div>
              </div>
        ...
        >
          <div className="relative w-full bg-white/80 dark:bg-zinc-900/90 backdrop-blur-xl rounded-3xl shadow-2xl border-2 border-orange-100 dark:border-yellow-700 px-8 py-10 animate-fade-in-up">
            ...
            <p className="text-zinc-700 dark:text-zinc-200 mb-6 max-w-lg text-lg animate-fade-in-up">
              ...
              responsibly to minimizing our carbon footprint and empowering our

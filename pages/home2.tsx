...
const Home2 = () => {
  ...
  return (
    <div className="bg-white dark:bg-zinc-900 transition-colors duration-300">
      ...
      <section
        className="relative flex flex-col md:flex-row items-center justify-between px-4 py-0 min-h-screen w-full overflow-hidden"
        data-aos="fade-up"
      >
        <video
        ...
        >
          ...
          <p className="text-lg md:text-2xl text-zinc-700 dark:text-zinc-200 mb-8 max-w-2xl">
        ...
        <div
          className="relative z-20 flex-1 flex justify-center items-center pt-16 pb-8"
          data-aos="fade-left"
        >
          <img
            src="/hero-food.png"
      ...
      >
        ...
        <div
          className="flex-1 flex flex-wrap gap-6 justify-center"
          data-aos="fade-left"
        >
          {[
            ...
            <div key={chef.name} className="w-32 flex flex-col items-center">
              <img
                src={chef.img}
                alt={chef.name}
                className="w-24 h-24 rounded-full mb-2 object-cover border-4 border-orange-200 dark:border-yellow-400"
              />
      ...
      >
        ...
        >
          {[
            { icon: "/pizza.svg", title: "Pizza" },
            { icon: "/burger.svg", title: "Burgers" },
            { icon: "/sushi.svg", title: "Sushi" },
            { icon: "/dessert.svg", title: "Desserts" },
            { icon: "/drinks.svg", title: "Drinks" },
            { icon: "/salad.svg", title: "Salads" },
          ].map((cat) => (
      ...
      >
        ...
        <div className="flex-1 flex flex-col gap-6" data-aos="fade-left">
          {[
            { icon: "/choose-menu.svg", title: "Choose Menu" },
            { icon: "/place-order.svg", title: "Place Order" },
            { icon: "/fast-delivery.svg", title: "Fast Delivery" },
            { icon: "/enjoy.svg", title: "Enjoy!" },
          ].map((step) => (
      ...
      <section
        className="py-16 px-4 w-full flex flex-col md:flex-row items-center gap-12 max-w-4xl mx-auto"
        data-aos="fade-up"
      >
        <div className="flex-1 flex flex-col items-start" data-aos="fade-right">
          <h2 className="text-3xl font-bold text-orange-600 dark:text-yellow-400 mb-6">
